...
type Output struct {
	...
	OperationalPayments    []*OperationalPayment    `protobuf:"bytes,51,rep,name=operational_payments,json=operationalPayments,proto3" json:"operational_payments,omitempty"`
	RewardPayments         []*RewardPayment         `protobuf:"bytes,52,rep,name=reward_payments,json=rewardPayments,proto3" json:"reward_payments,omitempty"`
	MapCreate              []*MapCreate             `protobuf:"bytes,53,rep,name=map_create,json=mapCreate,proto3" json:"map_create,omitempty"`
	MapConsumptionReward   []*MapConsumptionReward  `protobuf:"bytes,54,rep,name=map_consumption_reward,json=mapConsumptionReward,proto3" json:"map_consumption_reward,omitempty"`
...
func (x *Output) GetOperationalPayments() []*OperationalPayment {
	if x != nil {
		return x.OperationalPayments
	}
	return nil
}

func (x *Output) GetRewardPayments() []*RewardPayment {
	if x != nil {
		return x.RewardPayments
	}
	return nil
}

func (x *Output) GetMapCreate() []*MapCreate {
	if x != nil {
		return x.MapCreate
	}
	return nil
...
func (x *Output) GetMapConsumptionReward() []*MapConsumptionReward {
	if x != nil {
		return x.MapConsumptionReward
	}
	return nil
}
...
type OperationalPayment struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *OperationalPayment) Reset() {
	*x = OperationalPayment{}
	if protoimpl.UnsafeEnabled {
...
func (x *OperationalPayment) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*OperationalPayment) ProtoMessage() {}

func (x *OperationalPayment) ProtoReflect() protoreflect.Message {
	mi := &file_hivemapper_v1_hivemapper_proto_msgTypes[5]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use OperationalPayment.ProtoReflect.Descriptor instead.
func (*OperationalPayment) Descriptor() ([]byte, []int) {
	return file_hivemapper_v1_hivemapper_proto_rawDescGZIP(), []int{5}
}

func (x *OperationalPayment) GetMint() *Mint {
	if x != nil {
		return x.Mint
	}
	return nil
...
func (x *RewardPayment) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*RewardPayment) ProtoMessage() {}

func (x *RewardPayment) ProtoReflect() protoreflect.Message {
	mi := &file_hivemapper_v1_hivemapper_proto_msgTypes[7]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use RewardPayment.ProtoReflect.Descriptor instead.
func (*RewardPayment) Descriptor() ([]byte, []int) {
	return file_hivemapper_v1_hivemapper_proto_rawDescGZIP(), []int{7}
}

func (x *RewardPayment) GetMint() *Mint {
	if x != nil {
		return x.Mint
	}
	return nil
...
type MapConsumptionReward struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *MapConsumptionReward) Reset() {
	*x = MapConsumptionReward{}
	if protoimpl.UnsafeEnabled {
...
func (x *MapConsumptionReward) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*MapConsumptionReward) ProtoMessage() {}

func (x *MapConsumptionReward) ProtoReflect() protoreflect.Message {
	mi := &file_hivemapper_v1_hivemapper_proto_msgTypes[8]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use MapConsumptionReward.ProtoReflect.Descriptor instead.
func (*MapConsumptionReward) Descriptor() ([]byte, []int) {
	return file_hivemapper_v1_hivemapper_proto_rawDescGZIP(), []int{8}
}

func (x *MapConsumptionReward) GetMint() *Mint {
	if x != nil {
		return x.Mint
	}
	return nil
...
var file_hivemapper_v1_hivemapper_proto_rawDesc = []byte{
	...
	0x65, 0x73, 0x2e, 0x76, 0x31, 0x22, 0xbb, 0x07, 0x0a, 0x06, 0x4f, 0x75, 0x74, 0x70, 0x75, 0x74,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	0x72, 0x6f, 0x6d, 0x12, 0x16, 0x0a, 0x06, 0x61, 0x6d, 0x6f, 0x75, 0x6e, 0x74, 0x18, 0x05, 0x20,
	0x01, 0x28, 0x01, 0x52, 0x06, 0x61, 0x6d, 0x6f, 0x75, 0x6e, 0x74, 0x22, 0x73, 0x0a, 0x12, 0x49,
	0x6e, 0x69, 0x74, 0x69, 0x61, 0x6c, 0x69, 0x7a, 0x65, 0x64, 0x41, 0x63, 0x63, 0x6f, 0x75, 0x6e,
	0x74, 0x12, 0x19, 0x0a, 0x08, 0x74, 0x72, 0x78, 0x5f, 0x68, 0x61, 0x73, 0x68, 0x18, 0x01, 0x20,
	0x01, 0x28, 0x09, 0x52, 0x07, 0x74, 0x72, 0x78, 0x48, 0x61, 0x73, 0x68, 0x12, 0x18, 0x0a, 0x07,
	0x61, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x61,
	0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x12, 0x12, 0x0a, 0x04, 0x6d, 0x69, 0x6e, 0x74, 0x18, 0x03,
...
var file_hivemapper_v1_hivemapper_proto_msgTypes = make([]protoimpl.MessageInfo, 14)
var file_hivemapper_v1_hivemapper_proto_goTypes = []interface{}{
	...
	(*OperationalPayment)(nil),    // 5: hivemapper.types.v1.OperationalPayment
	(*Payment)(nil),               // 6: hivemapper.types.v1.Payment
	(*RewardPayment)(nil),         // 7: hivemapper.types.v1.RewardPayment
	(*MapConsumptionReward)(nil),  // 8: hivemapper.types.v1.MapConsumptionReward
	(*MapCreate)(nil),             // 9: hivemapper.types.v1.MapCreate
	(*Transfer)(nil),              // 10: hivemapper.types.v1.Transfer
	(*Mint)(nil),                  // 11: hivemapper.types.v1.Mint
	(*Burn)(nil),                  // 12: hivemapper.types.v1.Burn
	(*InitializedAccount)(nil),    // 13: hivemapper.types.v1.InitializedAccount
}
var file_hivemapper_v1_hivemapper_proto_depIdxs = []int32{
	...
	4,  // 3: hivemapper.types.v1.Output.ai_trainer_payments:type_name -> hivemapper.types.v1.AiTrainerPayment
	5,  // 4: hivemapper.types.v1.Output.operational_payments:type_name -> hivemapper.types.v1.OperationalPayment
	7,  // 5: hivemapper.types.v1.Output.reward_payments:type_name -> hivemapper.types.v1.RewardPayment
	9,  // 6: hivemapper.types.v1.Output.map_create:type_name -> hivemapper.types.v1.MapCreate
	8,  // 7: hivemapper.types.v1.Output.map_consumption_reward:type_name -> hivemapper.types.v1.MapConsumptionReward
	10, // 8: hivemapper.types.v1.Output.transfers:type_name -> hivemapper.types.v1.Transfer
	11, // 9: hivemapper.types.v1.Output.mints:type_name -> hivemapper.types.v1.Mint
	12, // 10: hivemapper.types.v1.Output.burns:type_name -> hivemapper.types.v1.Burn
	13, // 11: hivemapper.types.v1.Output.initialized_account:type_name -> hivemapper.types.v1.InitializedAccount
	11, // 12: hivemapper.types.v1.TokenSplittingPayment.manager_mint:type_name -> hivemapper.types.v1.Mint
	11, // 13: hivemapper.types.v1.TokenSplittingPayment.driver_mint:type_name -> hivemapper.types.v1.Mint
	11, // 14: hivemapper.types.v1.RegularDriverPayment.mint:type_name -> hivemapper.types.v1.Mint
	11, // 15: hivemapper.types.v1.NoSplitPayment.mint:type_name -> hivemapper.types.v1.Mint
	11, // 16: hivemapper.types.v1.AiTrainerPayment.mint:type_name -> hivemapper.types.v1.Mint
	11, // 17: hivemapper.types.v1.OperationalPayment.mint:type_name -> hivemapper.types.v1.Mint
	11, // 18: hivemapper.types.v1.Payment.mint:type_name -> hivemapper.types.v1.Mint
	11, // 19: hivemapper.types.v1.RewardPayment.mint:type_name -> hivemapper.types.v1.Mint
	11, // 20: hivemapper.types.v1.MapConsumptionReward.mint:type_name -> hivemapper.types.v1.Mint
	12, // 21: hivemapper.types.v1.MapCreate.burn:type_name -> hivemapper.types.v1.Burn
...
func file_hivemapper_v1_hivemapper_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_hivemapper_v1_hivemapper_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*OperationalPayment); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_hivemapper_v1_hivemapper_proto_msgTypes[8].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*MapConsumptionReward); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
